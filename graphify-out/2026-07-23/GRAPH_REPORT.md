...
## Corpus Check
- 184 files · ~39,792 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1840 nodes · 5160 edges · 74 communities (69 shown, 5 thin omitted)
...
Cohesion: 0.05
Nodes (50): AdminJobController, Authentication, GetMapping, Page, Pageable, PatchMapping, PostMapping, RequestMapping (+42 more)

### Community 1 - "Company & Job Mapping/Repos"
Cohesion: 0.06
Nodes (53): CategoryRepository, JobRepository, Mapper, Mapping, Category, AllArgsConstructor, Getter, Setter (+45 more)
...
Cohesion: 0.13
Nodes (20): ResumeRepository, AllArgsConstructor, Getter, Setter, Resume, Override, Page, Pageable (+12 more)

### Community 4 - "Recruiter Controller"
Cohesion: 0.22
Nodes (13): JpaRepository, AllArgsConstructor, Entity, Getter, NoArgsConstructor, Setter, Table, RecruiterEntity (+5 more)
...
Cohesion: 0.06
Nodes (44): ExtendWith, Pattern, AdminUserController, Authentication, GetMapping, Page, Pageable, PatchMapping (+36 more)

### Community 11 - "Auth Controller"
Cohesion: 0.17
Nodes (14): AllArgsConstructor, Getter, NoArgsConstructor, Setter, RecruiterResponse, Mapper, RecruiterMapper, Override (+6 more)

### Community 12 - "JWT Service"
Cohesion: 0.06
Nodes (36): ChannelInterceptor, ChannelRegistration, Claims, CurrentActorPort, EnableWebSocketMessageBroker, Key, Message, MessageBrokerRegistry (+28 more)
...
Cohesion: 0.22
Nodes (10): CompanyRepository, Company, AllArgsConstructor, Getter, Setter, CompanyAdapter, Override, Page (+2 more)
...
Cohesion: 0.18
Nodes (12): AuthController, PostMapping, RequestMapping, ResponseEntity, RestController, Getter, RefreshTokenRequest, AccessTokenResponse (+4 more)
...
Cohesion: 0.05
Nodes (55): InterviewFeedbackRepository, InterviewRepository, ResourceNotFoundException, Interview, AllArgsConstructor, Getter, Setter, InterviewFeedback (+47 more)

### Community 34 - "InterviewFeedbackEntity"
Cohesion: 0.16
Nodes (17): AuditEntityType, APPLICATION, CANDIDATE, JOB, USER, AuditLogEntity, Entity, Getter (+9 more)
...
Cohesion: 0.20
Nodes (3): InterviewRequest, Getter, Setter
...
Cohesion: 0.22
Nodes (11): AuditLogRepository, AuditLog, AllArgsConstructor, Getter, Setter, AuditLogView, AuditLogAdapter, Override (+3 more)
...
Cohesion: 0.21
Nodes (11): CandidateRepository, Candidate, AllArgsConstructor, Getter, Setter, CandidateView, CandidateAdapter, Override (+3 more)

### Community 43 - "RecruiterResponse"
Cohesion: 0.19
Nodes (9): CandidateController, Authentication, GetMapping, Page, Pageable, PatchMapping, RequestMapping, ResponseEntity (+1 more)
...
Cohesion: 0.27
Nodes (6): Mapper, Mapping, AllArgsConstructor, Getter, Setter, JobApplication
...
Cohesion: 0.36
Nodes (3): InterviewUseCase, Page, Pageable
...
Cohesion: 0.24
Nodes (11): RecruiterRepository, AllArgsConstructor, Getter, Setter, Recruiter, RecruiterView, Override, Page (+3 more)

### Community 56 - "WebSocketConfig"
Cohesion: 0.14
Nodes (12): CandidateResponse, AllArgsConstructor, Getter, NoArgsConstructor, Setter, CandidateService, CandidateRepository, Override (+4 more)

### Community 57 - "AdminJobController"
Cohesion: 0.23
Nodes (10): CandidateMapper, Mapper, JobApplicationMapper, JobMapper, UserMapper, InterviewRepository, JobApplicationRepository, JobRepository (+2 more)

### Community 58 - "CompanyEntity"
Cohesion: 0.27
Nodes (8): InterviewResponse, AllArgsConstructor, Getter, NoArgsConstructor, Setter, InterviewType, OFFLINE, ONLINE
...
Cohesion: 0.17
Nodes (12): CompanyMapper, Mapper, CompanyEntity, AllArgsConstructor, Entity, Getter, NoArgsConstructor, Setter (+4 more)
...
- **Why does `ApiResponse` connect `Admin Job Controller` to `Candidate Controller`, `Admin Company Controller`, `Resume Controller`, `Global Exception Handling & Config`, `User Request/Response DTOs`, `Admin Application Controller`, `Candidate Application Controller`, `Admin User Controller`, `Recruiter Application Controller`, `Auth Service & User Mapper`, `API Response Serialization Tests`, `InterviewFeedbackResponse`, `RecruiterResponse`, `AdminInterviewController.java`, `RecruiterInterviewController.java`, `NotificationEntity`, `InterviewController.java`, `ApiResponseSerializationTest.java`, `CandidateRequest`?**
  _High betweenness centrality (0.239) - this node is a cross-community bridge._
- **Why does `ResourceNotFoundException` connect `ResourceNotFoundException` to `Admin Job Controller`, `Company & Job Mapping/Repos`, `Candidate Controller`, `Company`, `Job Application Mapping/Repos`, `Admin Company Controller`, `User Entity & Repositories`, `Notification`, `Candidate`, `Global Exception Handling & Config`, `CandidateRequest`, `JWT Service`, `Job Application Service`, `Admin User Management`, `WebSocketAuthInterceptor`, `AdminJobController`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `Role` connect `JWT Service` to `InterviewFeedbackEntity`, `User Entity & Repositories`, `Candidate`, `User Request/Response DTOs`, `Auth Service & User Mapper`, `WebSocketConfig`?**
